package csu.soc.xwz.musicplayer.myView;
...
import csu.soc.xwz.musicplayer.utils.TextDrawUtils;
...
public class CharacterListView extends View {
    ...
    public CharacterListView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CharacterListView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttribute(AttributeSet attrs, int defStyleAttr) {
        ...
        //选中字母的颜色
        mSelectTextColor = typeArray.getColor(R.styleable.AZSideBarView_selectTextColor, Color.parseColor("#32CD32"));
        ...
        mHintTextSize = typeArray.getDimensionPixelOffset(R.styleable.AZSideBarView_hintTextSize,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 38,
                        getResources().getDisplayMetrics()));

        mHintCircleRadius = typeArray.getDimensionPixelOffset(R.styleable.AZSideBarView_hintCircleRadius,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 38,
                        getResources().getDisplayMetrics()));
        mHintCircleColor = typeArray.getColor(R.styleable.AZSideBarView_hintCircleColor, Color.parseColor("#91A56C"));
