...
import csu.soc.xwz.musicplayer.activity.DetailPlayerActivity;
...
//        Collections.sort(musicArrayList, new LetterComparater());
        musicArrayList = MusicResolver.musicArrayList;
        ...
        singleSongAdapter.setMyOnItemClickListener(new SingleSongAdapter.MyOnItemClickListener() {
            ...
            public void OnItemClickListener(View v) {
                ...
                if (mFragmentCallBack != null) {
                    ...
                    StaticValue.musiID = BaseActivity.myBinder.getMusicList().get(BaseActivity.myBinder.getCurrentIndex()).getMusicID();
