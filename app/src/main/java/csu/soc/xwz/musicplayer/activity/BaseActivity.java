...
public class BaseActivity extends AppCompatActivity implements View.OnClickListener{
    //全局数据库变量
    public static MusicPlayerHelper musicPlayerHelper;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState){
        ...
        musicPlayerHelper = new MusicPlayerHelper(this);
        db = musicPlayerHelper.getWritableDatabase();
        ...
        mFloatView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(myBinder.getMusicList() == null || myBinder.getMusicList().size() == 0) {
                    ...
                    StaticValue.musiID = myBinder.getMusicList().get(myBinder.getCurrentIndex()).getMusicID();
