...
public class RecentlyListAdapter extends RecyclerView.Adapter<RecentlyListAdapter.MyViewHolder>{
    static ArrayList<Music> musicArrayList;
    public interface MyOnItemClickListener {
        void OnItemClickListener(int position);
    }

    static RecentlyListAdapter.MyOnItemClickListener myOnItemClickListener;

    public void setMyOnItemClickListener(RecentlyListAdapter.MyOnItemClickListener myOnItemClickListener) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(final View v) {
            super(v);
            toolbar = v.findViewById(R.id.recent_item);
            toolbar.inflateMenu(R.menu.recent_item_menu);
    ...
    @Override
    public RecentlyListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recent_item, parent, false);
        RecentlyListAdapter.MyViewHolder vh = new RecentlyListAdapter.MyViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(RecentlyListAdapter.MyViewHolder holder, int position) {
