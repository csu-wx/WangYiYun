...
import csu.soc.xwz.musicplayer.Adapter.AlbumAdapter;
import csu.soc.xwz.musicplayer.Adapter.CollectAdapter;
import csu.soc.xwz.musicplayer.Adapter.DetailAdapter;
import csu.soc.xwz.musicplayer.Adapter.DirectoryAdapter;
import csu.soc.xwz.musicplayer.Adapter.RecentlyListAdapter;
import csu.soc.xwz.musicplayer.Adapter.SingerAdapter;
import csu.soc.xwz.musicplayer.Adapter.SingleSongAdapter;
...
public class TitleDecoration extends RecyclerView.ItemDecoration {
    ...
    public TitleDecoration(TitleAttributes attributes,String fragment) {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if(fragment.equals("singleSong")) {
            if (parent.getAdapter() == null || !(parent.getAdapter() instanceof SingleSongAdapter)) {
                return;
            }
            SingleSongAdapter adapter = (SingleSongAdapter) parent.getAdapter();
            ...
            if (parent.getAdapter() == null || !(parent.getAdapter() instanceof AlbumAdapter)) {
                return;
            }
            AlbumAdapter adapter = (AlbumAdapter) parent.getAdapter();
            if (adapter.getMusicArrayList() == null || adapter.getMusicArrayList().isEmpty()) {
                return;
            }
            for (int i = 0; i < parent.getChildCount(); i++) {
        ...
        } else if (fragment.equals("singer")) {
            if (parent.getAdapter() == null || !(parent.getAdapter() instanceof SingerAdapter)) {
                return;
            }
            SingerAdapter adapter = (SingerAdapter) parent.getAdapter();
            if (adapter.getMusicArrayList() == null || adapter.getMusicArrayList().isEmpty()) {
                return;
            }
            for (int i = 0; i < parent.getChildCount(); i++) {
        ...
        } else if (fragment.equals("detail")){
            ...
            if (parent.getAdapter() == null || !(parent.getAdapter() instanceof CollectAdapter)) {
                return;
            }
            CollectAdapter adapter = (CollectAdapter) parent.getAdapter();
            if (adapter.getMusicArrayList() == null || adapter.getMusicArrayList().isEmpty()) {
                return;
            }
            for (int i = 0; i < parent.getChildCount(); i++) {
